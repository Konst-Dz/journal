...
const form = useForm({
    ...
    start_date: props.course.start_date ? new Date(props.course.start_date) : null,
    end_date: props.course.end_date ? new Date(props.course.end_date) : null,
});
...
<template>
    <AppLayout>
        <div class="max-w-xl mx-auto">
            <h1 class="text-2xl font-bold mb-6">Редактирование курса</h1>
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-4">
                ...
                <div class="flex gap-2 mt-4">
                    ...
                    <Button type="button" label="Отмена" severity="secondary" @click="$inertia.visit(`/courses/${props.course.id}`)" />
                </div>
            </form>
        </div>
    </AppLayout>
