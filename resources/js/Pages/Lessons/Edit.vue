...
const form = useForm({
    ...
    scheduled_at: new Date(props.lesson.scheduled_at),
    duration_minutes: props.lesson.duration_minutes,
    type: props.lesson.type,
    status: props.lesson.status || 'pending',
});
...
const submit = () => {
    form.put(`/courses/${props.course.id}/lessons/${props.lesson.id}`);
};
</script>
...
<template>
    <AppLayout>
        <div class="max-w-xl mx-auto">
            <h1 class="text-2xl font-bold mb-6">Редактирование занятия</h1>
